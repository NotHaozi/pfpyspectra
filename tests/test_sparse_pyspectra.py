...
def test_sparse_general():
    ...
    run_test(spectra_sparse_interface.general_eigensolver,
...
def test_sparse_real_shift_general():
    ...
    run_test(spectra_sparse_interface.general_real_shift_eigensolver,
...
def test_sparse_complex_shift_general():
    ...
    run_test(spectra_sparse_interface.general_complex_shift_eigensolver,
             args, selection_rules)
...
def test_sparse_symmetric():
    ...
    args = (mat, PAIRS, SEARCH_SPACE)
    run_test(spectra_sparse_interface.symmetric_eigensolver,
             args, selection_rules)
...
def test_sparse_symmetric_shift():
    ...
    args = (mat, PAIRS, SEARCH_SPACE, SIGMA)
    run_test(spectra_sparse_interface.symmetric_shift_eigensolver,
             args, selection_rules)
...
#     run_test(spectra_sparse_interface.symmetric_generalized_shift_eigensolver,
#              args, selection_rules)
